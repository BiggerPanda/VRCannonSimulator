...
public partial class @TestInput : IInputActionCollection2, IDisposable
{
    ...
    private IRotateCannonActions m_RotateCannonActionsCallbackInterface;
    ...
    public struct RotateCannonActions
    {
        ...
        {
            if (m_Wrapper.m_RotateCannonActionsCallbackInterface != null)
            {
                @Left.started -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnLeft;
                @Left.performed -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnLeft;
                @Left.canceled -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnLeft;
                @Top.started -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnTop;
                @Top.performed -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnTop;
                @Top.canceled -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnTop;
                @Right.started -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnRight;
                @Right.performed -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnRight;
                @Right.canceled -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnRight;
                @Down.started -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnDown;
                @Down.performed -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnDown;
                @Down.canceled -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnDown;
                @PreciseMode.started -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnPreciseMode;
                @PreciseMode.performed -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnPreciseMode;
                @PreciseMode.canceled -= m_Wrapper.m_RotateCannonActionsCallbackInterface.OnPreciseMode;
            }
            m_Wrapper.m_RotateCannonActionsCallbackInterface = instance;
            if (instance != null)
            {
